...
export default function ProjectPage({ projects, currentSlug, globalMail }) {
  ...
  if (!mobile) return (
    ...
    >
      ...
      {isTouch && <>
        <div onClick={() => navigate(-1)} style={{ position: 'absolute', left: 0, top: 0, width: '50%', height: '100%', zIndex: 5 }} />
        <div onClick={() => navigate(1)}  style={{ position: 'absolute', right: 0, top: 0, width: '50%', height: '100%', zIndex: 5 }} />
      </>}
